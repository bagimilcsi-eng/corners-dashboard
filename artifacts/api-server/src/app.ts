...
<a href="/download/main.py">📄 main.py (Asztalitenisz bot)</a>
<a href="/download/corners_bot.py">📄 corners_bot.py (Szöglet bot)</a>
<a href="/download/requirements.txt">📄 requirements.txt (Csomagok)</a>
</body></html>`);
});
